...
export function PlanComparisonTable() {
  const features = [
    ...
    { name: "Trends radar", free: false, standard: false, pro: true, aiPowered: true },
  ...
  const plans = [
    {
      ...
      buttonClass: "border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-gray-900"
    },
    {
      name: "Standard Plan",
      price: "$47",
  ...
  return (
    <Section background="none" className="bg-gradient-to-br from-slate-900 via-gray-900 to-black py-16 sm:py-20 md:py-24">
      <SectionHeader 
        title={
        ...
        subtitle={
          <span className="text-gray-300 text-lg md:text-xl">
            Choose the ideal plan for your <span className="text-blue-400 font-semibold">content strategy needs</span>
          </span>
        } 
      ...
      <div className="hidden md:block max-w-6xl mx-auto overflow-x-auto">
        <motion.div
          className="min-w-[800px] grid grid-cols-4 border-2 border-gray-700 rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-gray-900 to-black"
